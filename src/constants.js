...
export const LEAVE_APP = {
    ...
    MESSAGES: {
        ...
        "FORM_ERROR": {
            title: "Error",
            message: "Something went wrong while fetching your information, please try again later.",
        },
        "CONFIRM_CANCEL": {
    ...
    COUNTRIES: {
        ...
        'AE': { code: 'AE', label: 'United Arab Emirates', phone: '971', serverName: 'UAE' },
        ...
        'NL': { code: 'NL', label: 'Netherlands', phone: '31', serverName: 'Netherland' },
        ...
        'SH': { code: 'SH', label: 'Saint Helena, Ascension And Tristan Da Cunha', phone: '290' },
        ...
        'UM': { code: 'UM', label: 'United States Minor Outlying Islands', phone: '1' },
...
export const PUBLIC_EMAIL_TEXT = "Your comment will be shown to all email recipients including"+LEAVE_APP.DEFAULT_EMAIL_RECIPIENTS.map((e)=>{return " "+e.Name+" ("+e.workEmail+")"}).join()+".";
export const PRIVATE_EMAIL_TEXT = "Your comment will only be shown to your lead and any emails that have been added.";